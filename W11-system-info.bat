...
powershell ^
$sys = Get-ComputerInfo -Property OSName,BiosSMBIOSBIOSVersion,OSDisplayVersion,OsBuildNumber,CsProcessors,CsPhyicallyInstalledMemory,OsTotalVisibleMemorySize; ^
